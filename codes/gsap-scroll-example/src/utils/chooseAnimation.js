...
/**
 * 选择 gsap 动画, 配合 scrollTrigger 使用
 * @param {String} animationType 自定义动画类型
 * @param {HTMLElement} grid gsap 容器DOM
*/
export const chooseAnimation = (animationType, grid) => {
    ...
    const timeline = gsap.timeline({
        defaults: {ease: "none"}, // 设置缓动函数为 none
        scrollTrigger: {
            trigger: gridWrap,
            start: 'top bottom+=5%',
            end: 'bottom top+=5%',
    ...
    switch(animationType) {
        ...
        case 'grid--2':
			...
			timeline.set(gridWrap, {rotationX: 20})
        ...
        case 'grid--4':
            ...
            timeline.set(gridWrap, {transformOrigin: '0% 50%',rotationY: 30,xPercent: -75,})
                ...
                .fromTo(gridItems,{rotationX: -70,filter: 'brightness(120%)',},
        ...
        case 'grid--5':
            ...
            timeline.set(gridWrap, {rotationX: 50})
